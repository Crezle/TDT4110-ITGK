...
Pizza=int(input("Hvor mye kostet pizzaen? (I kroner) "))
Studentrabatt=float(input("Hvor stor var studentrabatten? (Prosent i desimaltall) "))
Tips=float(input("Hvor mye ga du i tips? (Prosent i desimaltall) "))

Totalt=(Pizza-(Pizza*Studentrabatt))+((Pizza-(Pizza*Studentrabatt))*Tips)
print("Totalpris:", Totalt, "kr.")
...
print("Totalpris:", Totalt, "kr.")
pers=int(input("Hvor mange deltok på middagen? "))
print("Ettersom dere var", pers, "personer, så må hver person betale", (Totalt/pers),"kroner.")
