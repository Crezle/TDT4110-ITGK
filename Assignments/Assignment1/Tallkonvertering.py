...
str(sum_alder)
print(input("Hva syns dere om å være" + sum_alder + "? "))
...
sum_alder = alder + alder_mor
print("Gratulerer, til sammen er dere", sum_alder, "år!")
svar = str(input("Hva syns dere om å være " + str(sum_alder) + "? "))
...
float_1=float(input("Skriv inn et flyttall: "))
float_2=float(input("Skriv inn enda et flyttall: "))
float_3=float(input("Skriv inn et siste flyttall: "))
int_1=int(float_1)
int_2=int(float_2)
int_3=int(float_3)
print("Konvertert til heltall blir det:", int_1,int_2,int_3)
int_4=int(input("Skriv inn et heltall: "))
float_4=float(int_4)
print("Konvertert til flyttall blir det:", float_4)
...
age=int(input("Hei, " + name + " hvor gammel er du? "))
ageP=int(input("Hvor gammel var du da du begynte å programmere? "))
ageD=age-ageP
print("Du har programmert i", ageD,"år.")
if(ageD==1):
    str(input("Syns du det ene året har vært givende? "))
else:
    str(input("Syns du de " + str(ageD) + " årene har vært givende? "))
    print("Takk for svar,", name)
...
float_1=float(input("Hva er tallet ditt? "))
int_1=int(float_1)
print("Konvertert til heltall med int():", int(float_1))
print("Avrundet til nærmeste heltall:", round(float_1))
print("Avrundet til to desimaler:", round(float_1,2))
print("Avrundet til fire desimaler:", round(float_1,4))
print("Avrundet til nærmeste tusen:", round(int_1,-3))
print("Heltall fra int() kovertert tilbake til flyttall:",float(int_1))
...
float_1=float(input("Skriv et flyttall: "))
desimals=int(input("Hvor mange desimaler er ønskelig? "))
print("Tallet du skrev er", float_1, "og med", desimals, "desimaler blir det til", round(float_1,desimals))
