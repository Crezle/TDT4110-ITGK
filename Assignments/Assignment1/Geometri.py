...
omkrets=float(3.14*2*r)
print(f"Omkretsen er", round(omkrets,2))
areal=3.14*r**2
...
# **Svar:** Vet ikke helt hva grunnen er, med dette skjer når man ganger verdiene 3.11, 3.12, 3.13 og 3.14 med 10.
