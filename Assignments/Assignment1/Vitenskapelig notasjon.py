...
molV=int(input("Hva er molvekt i gram for " + stoff + "? "))
gStoff=int(input("Hvor mange gram " + stoff + " har du? "))
mol=6.022e23
molekyler=(gStoff/molV)*mol
...
antToner=int(input("Antall ulike 10-toners melodilinjer du har hørt? "))
muligeToner=8.25e19
print("Du har hørt", (antToner/muligeToner)*100, "prosent av melodier som er mulig.")
