...
pos=input("Oppgi din posisjon ")
bokstav = (pos[0])
tall = int(pos[1])
tbokstav = ord(bokstav)
if ((tall%2) == 1) and ((tbokstav%2))==1:
    print("Posisjon:", pos)
    print("Svart")
elif ((tall%2) == 1) and ((tbokstav%2))==0:
    print("Posisjon:", pos)
    print("Hvit")
elif ((tall%2) == 0) and ((tbokstav%2))==1:
    print("Posisjon:", pos)
    print("Hvit")
elif ((tall%2) == 0) and ((tbokstav%2))==0:
    print("Posisjon:", pos)
    print("Svart")
